...
function InventoryItemModal({
  ...
  const handleSubmit = async (e) => {
    ...
    if (isEditing && item?.productid) {
      dataToSubmit = {
          ...
          supplierid: formData.supplierid === "" || formData.supplierid === null ? null : parseInt(formData.supplierid, 10),
    ...
    console.log(`Data being submitted (${isEditing ? 'edit' : 'add'}):`, dataToSubmit);
  ...
  const allFields = [
    ...
    { label: "Current Stock", name: "current_stock", type: "number", required: true, min: "0" },
    ...
    { label: "Supplier ID", name: "supplierid", type: "number", required: false, showInAddMode: false },
    { label: "Price per Unit", name: "case_price", type: "number", required: false, step: "0.01", min: "0", showInAddMode: false },
    { label: "Order Unit", name: "order_unit", type: "text", required: false, showInAddMode: false },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          {fieldsToShow.map(({ label, name, type, required, placeholder, step, min }) => (
