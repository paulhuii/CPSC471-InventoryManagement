...
const OrderPending = () => {
      ...
      if (!order.order_detail || order.order_detail.length === 0) {
        ...
        for (const item of order.order_detail) {
          ...
          if (!productid) {
            ...
            alert(
              `Cannot update inventory for item ${
  ...
  const renderOrderSection = (title, filterStatus) => {
    ...
    return (
      <div className="mb-8">
        <h2 className="text-xl md:text-2xl font-semibold mb-4 text-[#2F4271]">
          {title}
        </h2>
        {filtered.length === 0 ? (
              ...
              >
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap gap-x-2 gap-y-1 items-center text-sm mt-1">
                    <label
                      htmlFor={`delivery-${order.orderid}`}
                ...
                <div className="flex flex-wrap items-center gap-2 w-full md:w-auto justify-start md:justify-end">
                  {isAdmin ? (
                    ...
                    <span className="text-sm text-gray-700 font-medium px-2 py-1">
